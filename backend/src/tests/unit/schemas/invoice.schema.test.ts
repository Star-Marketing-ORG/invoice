...
describe("Invoice Schema Validation - Enterprise Level", () => {
  describe("createInvoiceSchema", () => {
    ...
    it("should reject missing customerId", () => {
      const result = createInvoiceSchema.safeParse(
        invalidInvoices.missingCustomerId,
      );
    ...
    it("should reject item with missing serviceId", () => {
      const result = createInvoiceSchema.safeParse(
        invalidInvoices.missingServiceId,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should reject negative unit price", () => {
      const result = createInvoiceSchema.safeParse(
        invalidInvoices.negativeUnitPrice,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should reject negative discount", () => {
      const result = createInvoiceSchema.safeParse(
        invalidInvoices.negativeDiscount,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should reject discount over 100", () => {
      const result = createInvoiceSchema.safeParse(
        invalidInvoices.overMaxDiscount,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should accept discount 0 and 100", () => {
      expect(
        createInvoiceSchema.safeParse(boundaryInvoices.discountMin).success,
      ).toBe(true);
      expect(
        createInvoiceSchema.safeParse(boundaryInvoices.discountMax).success,
      ).toBe(true);
    });
    ...
    it("should accept tax 0 and 100", () => {
      expect(
        createInvoiceSchema.safeParse(boundaryInvoices.taxMin).success,
      ).toBe(true);
      expect(
        createInvoiceSchema.safeParse(boundaryInvoices.taxMax).success,
      ).toBe(true);
    });
    ...
    it("should reject item negative tax rate", () => {
      const result = createInvoiceSchema.safeParse(
        invalidInvoices.itemNegativeTaxRate,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should reject item tax rate > 100", () => {
      const result = createInvoiceSchema.safeParse(
        invalidInvoices.itemOverMaxTaxRate,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should reject item negative discount", () => {
      const result = createInvoiceSchema.safeParse(
        invalidInvoices.itemNegativeDiscount,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should reject item discount > 100", () => {
      const result = createInvoiceSchema.safeParse(
        invalidInvoices.itemOverMaxDiscount,
      );
      expect(result.success).toBe(false);
    });
  });
  ...
  describe("updateInvoiceStatusSchema", () => {
    it("should accept all valid statuses", () => {
      expect(
        updateInvoiceStatusSchema.safeParse(updateStatus.validDraft).success,
      ).toBe(true);
      expect(
        updateInvoiceStatusSchema.safeParse(updateStatus.validSent).success,
      ).toBe(true);
      expect(
        updateInvoiceStatusSchema.safeParse(updateStatus.validPartiallyPaid)
          .success,
      ).toBe(true);
      expect(
        updateInvoiceStatusSchema.safeParse(updateStatus.validPaid).success,
      ).toBe(true);
      expect(
        updateInvoiceStatusSchema.safeParse(updateStatus.validOverdue).success,
      ).toBe(true);
      expect(
        updateInvoiceStatusSchema.safeParse(updateStatus.validCancelled)
          .success,
      ).toBe(true);
    });
