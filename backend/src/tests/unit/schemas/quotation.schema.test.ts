  ...
  describe("createQuotationSchema", () => {
    ...
    it("should reject missing customerId", () => {
      const result = createQuotationSchema.safeParse(
        invalidQuotations.missingCustomerId,
      );
    ...
    it("should reject missing items", () => {
      const result = createQuotationSchema.safeParse(
        invalidQuotations.missingItems,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should reject item with missing serviceId", () => {
      const result = createQuotationSchema.safeParse(
        invalidQuotations.missingServiceId,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should reject item with zero quantity", () => {
      const result = createQuotationSchema.safeParse(
        invalidQuotations.zeroQuantity,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should reject item with negative unit price", () => {
      const result = createQuotationSchema.safeParse(
        invalidQuotations.negativeUnitPrice,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should reject negative discount", () => {
      const result = createQuotationSchema.safeParse(
        invalidQuotations.negativeDiscount,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should reject discount over 100", () => {
      const result = createQuotationSchema.safeParse(
        invalidQuotations.overMaxDiscount,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should accept discount 0", () => {
      const result = createQuotationSchema.safeParse(
        boundaryQuotations.discountMin,
      );
      expect(result.success).toBe(true);
    });
    ...
    it("should accept discount 100", () => {
      const result = createQuotationSchema.safeParse(
        boundaryQuotations.discountMax,
      );
      expect(result.success).toBe(true);
    });
    ...
    it("should reject item negative tax rate", () => {
      const result = createQuotationSchema.safeParse(
        invalidQuotations.itemNegativeTaxRate,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should reject item tax rate over 100", () => {
      const result = createQuotationSchema.safeParse(
        invalidQuotations.itemOverMaxTaxRate,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should reject item negative discount", () => {
      const result = createQuotationSchema.safeParse(
        invalidQuotations.itemNegativeDiscount,
      );
      expect(result.success).toBe(false);
    });
    ...
    it("should reject item discount over 100", () => {
      const result = createQuotationSchema.safeParse(
        invalidQuotations.itemOverMaxDiscount,
      );
      expect(result.success).toBe(false);
    });
  ...
  describe("updateQuotationSchema", () => {
    it("should accept partial update", () => {
      const result = updateQuotationSchema.safeParse(
        updateQuotations.partialUpdate,
      );
      expect(result.success).toBe(true);
    });
    ...
    it("should reject invalid status", () => {
      const result = updateQuotationSchema.safeParse(
        updateQuotations.invalidStatus,
      );
      expect(result.success).toBe(false);
    });
  });
